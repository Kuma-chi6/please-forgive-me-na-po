...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "Knew it baby, Love you 😘";
  yes.innerHTML = '<a href="https://www.facebook.com/profile.php?id=61580199385748">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
